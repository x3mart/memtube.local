    ...
    <ul class="custom-scrollbar">
        ...
        <li>
            <ul class="collapsible collapsible-accordion">
                <li>
                    <a href="{{ route('favourite') }}" class="collapsible-header waves-effect"><i
                            class="fas fa-star"></i> Избранные</a>
                </li>
                <li>
                    <a href="{{ route('downloaded') }}" class="collapsible-header waves-effect"><i
                            class="fas fa-download"></i> Скачанные</a>
                </li>
                @if ($user->isAdmin)
                <li>
                    <a href="{{ route('video-manager') }}" class="collapsible-header waves-effect"><i
                            class="fas fa-film"></i> Управление видео</a>
                </li>
                @endif
                <li>
                    <a href="{{ route('password-restore') }}" class="collapsible-header waves-effect"><i
